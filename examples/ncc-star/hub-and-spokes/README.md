# GCP Terraform Example: Ncc Star - Hub And Spokes

This example demonstrates how to deploy and manage infrastructure for **Ncc Star - Hub And Spokes** using standard foundation Terraform modules.

## Architecture & Resources Created

### Modules Called
- **`module.center_vpc`**: Source `"../../../modules/network-foundation"`
- **`module.edge_vpc`**: Source `"../../../modules/network-foundation"`
- **`module.ncc`**: Source `"../../../modules/ncc-star"`
...
cd examples/ncc-star/hub-and-spokes
