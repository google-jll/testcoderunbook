# GCP Terraform Example: Compute Vm - Confidential Computing Intel

This example demonstrates how to deploy and manage infrastructure for **Compute Vm - Confidential Computing Intel** using standard foundation Terraform modules.
...
cd examples/compute-vm/confidential_computing_intel
