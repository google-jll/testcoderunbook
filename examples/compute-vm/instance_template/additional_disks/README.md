# GCP Terraform Example: Compute Vm - Instance Template - Additional Disks

This example demonstrates how to deploy and manage infrastructure for **Compute Vm - Instance Template - Additional Disks** using standard foundation Terraform modules.
...
cd examples/compute-vm/instance_template/additional_disks
