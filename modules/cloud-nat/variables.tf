...
variable "router_asn" {
  type        = string
  description = "Router ASN, only used when create_router is true. Null (default) creates the router WITHOUT a BGP block (correct for a plain NAT gateway); set an ASN to add BGP."
  default     = null
}
